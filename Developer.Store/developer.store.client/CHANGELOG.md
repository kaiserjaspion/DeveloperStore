...
- Create Angular project with ng: `ng new developer.store.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`developer.store.client.esproj`).
